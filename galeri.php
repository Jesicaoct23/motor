...
<head>
    ...
    <title>Galeri Foto - Jejes MotoClub</title>
    <!-- Bootstrap CSS -->
                ...
                <section id="gallery">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="gambar/gsleri1.jpeg" class="card-img-top" alt="Foto 1">
                            </div>
                        </div>
                        <!-- Gambar 2 -->
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="gambar/galeri2.jpeg" class="card-img-top" alt="Foto 2">
                            </div>
                        </div>
                        <!-- Gambar 3 -->
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="gambar/galeri3.jpeg" class="card-img-top" alt="Foto 3">
                            </div>
                        </div>
                        <!-- Gambar 4 -->
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="gambar/galeri4.jpeg" class="card-img-top" alt="Foto 4">
                            </div>
                        </div>
                        <!-- Gambar 5 -->
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="gambar/galeri5.jpeg" class="card-img-top" alt="Foto 5">
                            </div>
                        </div>
                        <!-- Gambar 6 -->
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="gambar/galeri6.jpeg" class="card-img-top" alt="Foto 6">
                            </div>
                        </div>
